...
class ButtonPluginTest extends TestCase {
    ...
    public function testParameter()
    {
        ...
        $tests = array(
            ...
            'nopage' => array(
                'button' => array('Keishi'),
                'assert' => '<a class="haik-plugin-button btn btn-default" href="'.url('haik-admin/edit/Keishi').'">test</a>',
            ),
            'none' => array(
                'button' => array('FrontPage'),
                'assert' => '<a class="haik-plugin-button btn btn-default" href="'.url('FrontPage').'">test</a>',
            ),
            'primary' => array(
                'button' => array('FrontPage', 'primary'),
                'assert' => '<a class="haik-plugin-button btn btn-primary" href="'.url('FrontPage').'">test</a>',
            ),
            'large' => array(
                'button' => array('FrontPage', 'large'),
                'assert' => '<a class="haik-plugin-button btn btn-default btn-lg" href="'.url('FrontPage').'">test</a>',
            ),
            'small' => array(
                'button' => array('FrontPage', 'small'),
                'assert' => '<a class="haik-plugin-button btn btn-default btn-sm" href="'.url('FrontPage').'">test</a>',
            ),
            'mini' => array(
                'button' => array('FrontPage', 'mini'),
                'assert' => '<a class="haik-plugin-button btn btn-default btn-xs" href="'.url('FrontPage').'">test</a>',
            ),
            'block' => array(
                'button' => array('FrontPage', 'block'),
                'assert' => '<a class="haik-plugin-button btn btn-default btn-block" href="'.url('FrontPage').'">test</a>',
            ),
            'custom' => array(
                'button' => array('FrontPage', 'custom'),
                'assert' => '<a class="haik-plugin-button btn btn-default custom" href="'.url('FrontPage').'">test</a>',
            ),
        );
